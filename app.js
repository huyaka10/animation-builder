    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'latam', name: 'Латинская Америка', level: 2, values: ['88 883,88', '91 133,01|+0,52%', '89 009,45|+0,03%', '90 120,44|+0,29%'] },
        ],
      },
      {
        id: 'subscription',
        ...
        children: [
          ...
          { id: 'annual', name: 'Годовая', level: 2, values: ['221 992,00', '220 115,45|-0,10%', '225 881,45|+0,29%', '222 002,21|+0,01%'] },
        ],
      },
      {
        id: 'average-check',
...
const expanded = new Set(metrics.map((m) => m.id));
